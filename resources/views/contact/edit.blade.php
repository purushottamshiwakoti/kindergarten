...
<div class="container">
    ...
    <form action="{{ route('contact.update', $contact->id) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="phone_number" class="form-control w-50" value="{{ $contact->phone_number }}"
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email1" class="form-control w-50" value="{{ $contact->email1 }}"
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email2" class="form-control w-50" value="{{ $contact->email2 }}"
